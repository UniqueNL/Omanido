...
product11 = Product.create(featured: true, name: "Vergrootglas ketting", amount: 11, image: "http://res.cloudinary.com/mippet/image/upload/v1476367951/omanido/Vergrootglas%20ketting.jpg", price: 13.00, description: "Voor op vakantie of in de bibliotheek, waar u ook bent: gebruik deze handige ketting. U nooit het vergrootglas kwijt, en altijd alles kunnen lezen.", short_description: "Mobiel zijn? en toch kunnen lezen?")
