...
product11 = Product.create(featured: true, name: "Vergrootglas ketting", amount: 11, image: "http://res.cloudinary.com/mippet/image/upload/v1476367951/omanido/Vergrootglas%20ketting.jpg", price: 13.20, description: "Voor op vakantie of in de bibliotheek, waar u ook bent: gebruik deze handige ketting. U nooit het vergrootglas kwijt, en altijd alles kunnen lezen.", short_description: "Mobiel zijn? en toch kunnen lezen?")
...
product14 = Product.create(name: "Open u Blik", amount: 24, image: "http://res.cloudinary.com/mippet/image/upload/v1476368080/omanido/Open%20u%20Blik.jpg", price: 7.40, description: "nooit meer ruzie met de lipje van een blikje, dat afbreekt voor je hem openhebt. vanaf nu is er de Blik open u.", short_description: "als u het even niet meer ziet zitten")
product15 = Product.create(featured: true, name: "Schroefdop opener", amount: 9, image: "http://res.cloudinary.com/mippet/image/upload/v1476368107/omanido/Schroefdop%20opener.jpg", price: 3.99, description: "De oude melkpakken waren al erg, maar de schroefdoppen zijn ook niet altijd handig!", short_description: "makkelijk elk pak melk open")
product16 = Product.create(name: "Petfles handvat", amount: 56, image: "http://res.cloudinary.com/mippet/image/upload/v1476368172/omanido/Petfles%20handvat.jpg", price: 10.50, description: "Zeker wel! met dit fijne handvat. Het gewicht ligt anders, en u hoeft niet langer met 2 handen de fles vast te houden.", short_description: "Zo'n Colafles van 2liter is niet uit te schenken?")
...
product18 = Product.create(featured: true, name: "Opblaasbare haarwasbak", amount: 23, image: "http://res.cloudinary.com/mippet/image/upload/v1476368226/omanido/Opblaasbare%20haarwasbak.jpg", price: 11.00, description: "Hoeft niet langer met deze opblaasbare haarwasbak. Makkelijk op te bergen en te gebruiken.", short_description: "onhandig voorover gebogen boven een bad staan")
product19 = Product.create(name: "Badkussen", amount: 22, image: "http://res.cloudinary.com/mippet/image/upload/v1476368246/omanido/Badkussen.jpg", price: 5.10, description: "Nog meer relaxen met dit heerlijken badkussen. Geen harde oppervlakte maar een zachte. En ook nog is makkelijk op te bergen, of te laten hangen wat mogelijk is door de zuignapjes aan de achterkant.", short_description: "Rustig in bad")
...
product21 = Product.create(name: "Olifantpoten", amount: 56, image: "http://res.cloudinary.com/mippet/image/upload/v1476368310/omanido/Olifantpoten.jpg", price: 2.10, description: "Is de stoel net te laag? of het bed? de tafel of het kastje? Met deze olifantenpoten verhoogt u gemakkelijk elke oppervlakte.", short_description: "Alles mag een stukkie hoger")
